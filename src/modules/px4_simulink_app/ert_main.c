 ...
 * File: ert_main.c
 *
 * Code generated for Simulink model 'variable_pitch_PX4_2016_v8'.
 *
 * Model version                  : 1.372
 * Simulink Coder version         : 8.11 (R2016b) 25-Aug-2016
 * C/C++ source code generated on : Tue Nov 21 13:59:52 2017
 *
...
#include <stdio.h>
#include <stdlib.h>
#include "variable_pitch_PX4_2016_v8.h"
#include "variable_pitch_PX4_2016_v8_private.h"
#include "rtwtypes.h"
#include "limits.h"
...
void baseRateTask(void *arg)
{
  ...
  noErr = (rtmGetErrorStatus(variable_pitch_PX4_2016_v8_M) == (NULL));
  int sem_value;
  while (noErr ) {
    ...
    variable_pitch_PX4_2016_v8_step();
...
void terminateTask(void *arg)
{
  ...
  /* Terminate model */
  variable_pitch_PX4_2016_v8_terminate();
  sem_post(&stopSem);
}
...
void SpawnThreads_Task(void *arg)
{
  variable_pitch_PX4_2016_v8_initialize();
  sleep(1);
...
void ShutDown_Procedure()
{
  ...
  rtmSetErrorStatus(variable_pitch_PX4_2016_v8_M, "Module finished");
